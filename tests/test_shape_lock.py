...
from mc_art.geometry import compile_geometry
from mc_art.pipeline import _reference_shape_is_locked
from mc_art.reference_geometry import (
...
def test_a_uv_atlas_keeps_its_own_alpha_authority(tmp_path: Path) -> None:
    ...
    from mc_art.contracts import UvRegionSpec
